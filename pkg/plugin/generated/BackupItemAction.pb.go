...
func (*ExecuteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_526066c044cdc597, []int{0}
}
...
func (*ExecuteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_526066c044cdc597, []int{1}
}
...
func init() { proto.RegisterFile("BackupItemAction.proto", fileDescriptor_526066c044cdc597) }

var fileDescriptor_526066c044cdc597 = []byte{
...
func (*UnimplementedBackupItemActionServer) AppliesTo(ctx context.Context, req *AppliesToRequest) (*AppliesToResponse, error) {
	return nil, errUnimplemented("AppliesTo")
}
func (*UnimplementedBackupItemActionServer) Execute(ctx context.Context, req *ExecuteRequest) (*ExecuteResponse, error) {
