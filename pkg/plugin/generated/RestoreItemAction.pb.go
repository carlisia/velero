...
func (*RestoreItemActionExecuteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d398a33f1080c362, []int{0}
}

func (m *RestoreItemActionExecuteRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RestoreItemActionExecuteRequest.Unmarshal(m, b)
}
func (m *RestoreItemActionExecuteRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RestoreItemActionExecuteRequest.Marshal(b, m, deterministic)
}
func (m *RestoreItemActionExecuteRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RestoreItemActionExecuteRequest.Merge(m, src)
}
func (m *RestoreItemActionExecuteRequest) XXX_Size() int {
	return xxx_messageInfo_RestoreItemActionExecuteRequest.Size(m)
}
func (m *RestoreItemActionExecuteRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RestoreItemActionExecuteRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RestoreItemActionExecuteRequest proto.InternalMessageInfo
...
func (*RestoreItemActionExecuteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d398a33f1080c362, []int{1}
}

func (m *RestoreItemActionExecuteResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RestoreItemActionExecuteResponse.Unmarshal(m, b)
}
func (m *RestoreItemActionExecuteResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RestoreItemActionExecuteResponse.Marshal(b, m, deterministic)
}
func (m *RestoreItemActionExecuteResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RestoreItemActionExecuteResponse.Merge(m, src)
}
func (m *RestoreItemActionExecuteResponse) XXX_Size() int {
	return xxx_messageInfo_RestoreItemActionExecuteResponse.Size(m)
}
func (m *RestoreItemActionExecuteResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RestoreItemActionExecuteResponse.DiscardUnknown(m)
}

var xxx_messageInfo_RestoreItemActionExecuteResponse proto.InternalMessageInfo
...
func init() { proto.RegisterFile("RestoreItemAction.proto", fileDescriptor_d398a33f1080c362) }

var fileDescriptor_d398a33f1080c362 = []byte{
...
func (*UnimplementedRestoreItemActionServer) AppliesTo(ctx context.Context, req *AppliesToRequest) (*AppliesToResponse, error) {
	return nil, errUnimplemented("AppliesTo")
}
func (*UnimplementedRestoreItemActionServer) Execute(ctx context.Context, req *RestoreItemActionExecuteRequest) (*RestoreItemActionExecuteResponse, error) {
