...
func (*CreateVolumeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{0}
}
...
func (*CreateVolumeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{1}
}
...
func (*GetVolumeInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{2}
}
...
func (m *GetVolumeInfoRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVolumeInfoRequest.Merge(m, src)
}
...
func (*GetVolumeInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{3}
}
...
func (m *GetVolumeInfoResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVolumeInfoResponse.Merge(m, src)
}
...
func (*CreateSnapshotRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{4}
}
...
func (*CreateSnapshotResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{5}
}
...
func (*DeleteSnapshotRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{6}
}
...
func (*GetVolumeIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{7}
}
...
func (m *GetVolumeIDRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVolumeIDRequest.Merge(m, src)
}
...
func (*GetVolumeIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{8}
}
...
func (m *GetVolumeIDResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetVolumeIDResponse.Merge(m, src)
}
...
func (*SetVolumeIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{9}
}
...
func (m *SetVolumeIDRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetVolumeIDRequest.Merge(m, src)
}
...
func (*SetVolumeIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_44650d9c2caffbd1, []int{10}
}
...
func (m *SetVolumeIDResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SetVolumeIDResponse.Merge(m, src)
}
...
func init() { proto.RegisterFile("VolumeSnapshotter.proto", fileDescriptor_44650d9c2caffbd1) }

var fileDescriptor_44650d9c2caffbd1 = []byte{
...
func (*UnimplementedVolumeSnapshotterServer) Init(ctx context.Context, req *InitRequest) (*Empty, error) {
	return nil, errUnimplemented("Init")
}
func (*UnimplementedVolumeSnapshotterServer) CreateVolumeFromSnapshot(ctx context.Context, req *CreateVolumeRequest) (*CreateVolumeResponse, error) {
	return nil, errUnimplemented("CreateVolumeFromSnapshot")
}
func (*UnimplementedVolumeSnapshotterServer) GetVolumeInfo(ctx context.Context, req *GetVolumeInfoRequest) (*GetVolumeInfoResponse, error) {
	return nil, errUnimplemented("GetVolumeInfo")
}
func (*UnimplementedVolumeSnapshotterServer) CreateSnapshot(ctx context.Context, req *CreateSnapshotRequest) (*CreateSnapshotResponse, error) {
	return nil, errUnimplemented("CreateSnapshot")
}
func (*UnimplementedVolumeSnapshotterServer) DeleteSnapshot(ctx context.Context, req *DeleteSnapshotRequest) (*Empty, error) {
	return nil, errUnimplemented("DeleteSnapshot")
}
func (*UnimplementedVolumeSnapshotterServer) GetVolumeID(ctx context.Context, req *GetVolumeIDRequest) (*GetVolumeIDResponse, error) {
	return nil, errUnimplemented("GetVolumeID")
}
func (*UnimplementedVolumeSnapshotterServer) SetVolumeID(ctx context.Context, req *SetVolumeIDRequest) (*SetVolumeIDResponse, error) {
	return nil, errUnimplemented("SetVolumeID")
}
