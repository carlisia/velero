...
func (*PluginIdentifier) Descriptor() ([]byte, []int) {
	return fileDescriptor_5001e11d80703bdc, []int{0}
}
...
func (m *PluginIdentifier) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PluginIdentifier.Merge(m, src)
}
...
func (*ListPluginsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5001e11d80703bdc, []int{1}
}
...
func init() { proto.RegisterFile("PluginLister.proto", fileDescriptor_5001e11d80703bdc) }

var fileDescriptor_5001e11d80703bdc = []byte{
...
func (*UnimplementedPluginListerServer) ListPlugins(ctx context.Context, req *Empty) (*ListPluginsResponse, error) {
	return nil, errUnimplemented("ListPlugins")
}
